...
export default function Header() {
  ...
  return (
    <Navbar className="navbar-header" dark lg collapseOnSelect >
      <Container>
        <Navbar.Brand href="/" style={{ display: "flex", alignContent: "center", alignItems: "center", marginLeft: "15px" }}>
          ...
          <b className="snake" style={{ marginLeft: "10px", fontSize: "xx-large" }}>SNAKE WORLD</b>
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="navbar-mtavari">
