...
function ReptileItem({
    ...
    return (
        <div className="bla col-12 col-md-6 col-lg-4" style={{ marginTop: "50px", width: "600px" }}>

            <div  class="card card-cont" style={{ borderRadius: "12px", padding: "15px" }}>
                ...
                <div className='flex-horizontal'>
                    <a href={'/reptiles/' + id} className="btn rounded-pill btn-dark" style={{ width: "100%", margin: "0px 0px 5px 0px" }}>დეტალურად</a>
                    {
                        isSignedIn ? (
